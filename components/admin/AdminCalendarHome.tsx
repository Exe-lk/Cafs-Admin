      ...
      {dayColumns.map((colDate) => {
        ...
        return (
          <div
            ...
            className="group relative min-h-[80px] border-b border-r border-mgmt-outline-variant/25 bg-white last:border-r-0 hover:bg-mgmt-surface-container-low text-left cursor-pointer"
