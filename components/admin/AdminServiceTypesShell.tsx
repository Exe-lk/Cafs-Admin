...
export default function AdminServiceTypesShell({ children }: { children: ReactNode }) {
  ...
  const options = useMemo(
    () => [
      ...
      { label: "Classes", href: "/admin/service-types/classes" },
    ],
    [],
  );

  const active = pathname?.startsWith("/admin/service-types/classes") ? options[1]! : options[0]!;
